  ...
  render(){
    return(
      <div>
        ...
        <h1 className="title-club" >CLUB PEINTURE</h1>
          </div>
...
Aquarelle<br/>
Technique mixte<br/>
Nous vous enseignerons à peindre ou dessiner selon votre niveau et vos objectifs.
Paysage,<br/>
Portrait,<br/>
Floral,<br/>
Nature morte,<br/>
...
<br/>
<h2><b>Professeur :</b></h2> René Milone.<br/>

<b>Différentes options sont offertes pour le matériel :</b><br/>
