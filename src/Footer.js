...
class FooterPage extends React.Component {
    render(){
        return(
            <Footer color="#ffd180 orange accent-1
            " className="font-small pt-0">
                <Container >
                    <Row  style={{height:'50px'}} >
                        <Col md="12" style={{marginLeft:'100%'}} >
                ...
                <div className="footer-copyright text-center py-3">
                    <Container fluid>
                        &copy; {(new Date().getFullYear())} Copyright: Site créé par <a href=" https://www.linkedin.com/in/marwa-krimi">Marwa KRIMI </a> & <a href="https://www.MDBootstrap.com">Sawsen MACHTA </a>
                    </Container>
                </div>
            </Footer>
        );
